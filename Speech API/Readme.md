...
![](https://github.com/sarthakmahapatra/Mini-Hacks/tree/master/Speech%20API/Images/01-Cognitive-Services-Selection.png)
...
![](https://github.com/sarthakmahapatra/Mini-Hacks/tree/master/Speech%20API/Images/02-Cognitive-Services-Creation.png)


Once the service is created, click on Keys section and note down the keys.

![](https://github.com/sarthakmahapatra/Mini-Hacks/tree/master/Speech%20API/Images/03-Cognitive-Services-Keys.png)
...
* Add `SpeechViewModel.cs`, class. This will be the ViewModel that will interact with the View.
