...
=============
　
In this challenge, you must add Authentication in your app by at least two of these providers: Facebook, Google, Microsoft and Twitter. 
##Walkthrough:
You can begin by  creating a Mobile app on Azure. Later you can follow steps for registering your applications with your favorite providers and adding the details of the same to Azure app.
...
　
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/a.png)

Add required details and click on Create.

　
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/B.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/C.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/D.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/E.png)


![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/F.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/H.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/I.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/J.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/K.png)

3.	Navigate to the Twitter Developers website, sign in with your Twitter account credentials, and click Create New App.

![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/L.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/M.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/N.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/O.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/P.png)

　
5.	Under Social APIs click Google+ API and then Enable.


![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/Q.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/R.png)


8.	In the Credentials tab, click Create credentials > OAuth client ID, then select Web application.
　

![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/S.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/T.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/U.png)
...
![IMAGE](https://github.com/nishanil/Mini-Hacks/blob/master/AzureAuthentication/Images/V.png)
